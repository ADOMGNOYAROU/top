    ...
    <div class="layout">
      ...
      @if (sidebarOpen) {
        <div
          ...
          (keydown.space)="sidebarOpen = false"
          role="button"
          tabindex="0"
        ></div>
      }
      ...
      <aside class="sidebar" [class.open]="sidebarOpen">
        ...
        >
          ...
          <a
            routerLink="/gestionnaire/portefeuille"
            routerLinkActive="active"
            class="nav-item"
          >
            <svg
          ...
          <a
            routerLink="/gestionnaire/locataires"
            routerLinkActive="active"
            class="nav-item"
          >
            <svg
          ...
          <a
            routerLink="/gestionnaire/paiements"
            routerLinkActive="active"
            class="nav-item"
          >
            <svg
          ...
          <a
            routerLink="/gestionnaire/rapports"
            routerLinkActive="active"
            class="nav-item"
          >
            <svg
          ...
          <a
            routerLink="/gestionnaire/profil-public"
            routerLinkActive="active"
            class="nav-item"
          >
            <svg
  ...
  ngOnInit(): void {
    try {
      ...
      if (raw) {
        ...
        this.nom = u.nom || "";
        this.initiales =
          ((u.prenom?.[0] || "") + (u.nom?.[0] || "")).toUpperCase() || "G";
      }
    } catch {
