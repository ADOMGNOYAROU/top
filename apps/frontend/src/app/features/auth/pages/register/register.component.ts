            ...
            <div class="testimonial">
              ...
              <div class="testimonial-content">
                ...
                <p class="testimonial-quote">
                  "WARAH a transformé la gestion de mes biens. Simple,
                  efficace."
                </p>
          ...
          <div class="right-content">
            ...
            <div class="type-pills">
              <button
                type="button"
                class="type-pill"
                [class.active]="selectedUserType === 'proprietaire_local'"
                (click)="selectUserType('proprietaire_local')"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
              ...
              <button
                type="button"
                class="type-pill"
                [class.active]="selectedUserType === 'proprietaire_diaspora'"
                (click)="selectUserType('proprietaire_diaspora')"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
              ...
              <button
                type="button"
                class="type-pill"
                [class.active]="selectedUserType === 'locataire'"
              ...
              <button
                type="button"
                class="type-pill"
                [class.active]="selectedUserType === 'gestionnaire'"
                (click)="selectUserType('gestionnaire')"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
            ...
            >
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  <label class="form-label" for="register-telephone"
                    >Téléphone</label
                  >
              ...
              <div class="form-row">
                <div class="form-group">
                  <label class="form-label" for="register-mot-de-passe"
                    >Mot de passe</label
                  >
                  <div class="input-wrapper">
                    <input
                ...
                <div class="form-group">
                  <label class="form-label" for="register-confirm-mot-de-passe"
                    >Confirmer</label
                  >
                  <div class="input-wrapper">
                    <input
...
export class RegisterComponent implements OnInit {
  ...
  registerForm: ReturnType<RegisterComponent["buildForm"]>;
  ...
  onSubmit(): void {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem(
        "warah_user",
        JSON.stringify(mockResponse.utilisateur),
      );
