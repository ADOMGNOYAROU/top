            ...
            <div class="lg:col-span-2 space-y-6">
              ...
              >
                ...
                <div class="flex items-start gap-6">
                  <div
                    class="flex-shrink-0 w-20 h-20 bg-primary-light rounded-full flex items-center justify-center text-primary font-bold text-2xl"
                  >
                    {{ proprietaire.prenoms.charAt(0)
                    }}{{ proprietaire.nom.charAt(0) }}
                  </div>
                  <div class="flex-1">
                    <h3 class="text-xl font-semibold text-gray-900">
                      {{ proprietaire.prenoms }} {{ proprietaire.nom }}
                    </h3>
                ...
                <div class="space-y-2">
                  <div class="flex items-center gap-3">
                    ...
                    <span class="text-gray-700"
                      >{{ proprietaire.adresse.quartier }},
                      {{ proprietaire.adresse.ville }}</span
                    >
                  </div>
                  @if (proprietaire.adresse.adresseComplete) {
                    <div class="flex items-center gap-3">
                      ...
                      <span class="text-gray-700">{{
                        proprietaire.adresse.adresseComplete
                      }}</span>
                    </div>
                  }
                </div>
                ...
                <div class="space-y-3">
                  <div class="flex items-center justify-between">
                    ...
                    <span class="font-medium text-gray-900">{{
                      getPieceIdentiteType()
                    }}</span>
                  </div>
                  <div class="flex items-center justify-between">
                    <span class="text-sm text-gray-600">Numéro</span>
                    <span class="font-medium text-gray-900">{{
                      proprietaire.pieceIdentite.numero
                    }}</span>
                  </div>
              ...
              >
                ...
                <div class="flex items-center gap-3">
                  ...
                  <span class="text-gray-900 font-medium">{{
                    proprietaire.dateCreation | date: "dd MMMM yyyy"
                  }}</span>
                </div>
              </div>
...
export class ProprietaireDetailComponent implements OnInit {
  ...
  deleteProprietaire(): void {
    if (
      this.proprietaire &&
      confirm("Êtes-vous sûr de vouloir supprimer ce propriétaire ?")
    ) {
      this.proprietairesService
        .deleteProprietaire(this.proprietaire.id)
        .subscribe({
          next: () => {
            void this.router.navigate(["/proprietaires"]);
          },
