...
import {
  Proprietaire,
  StatutProprietaire,
} from "@core/models/proprietaire.model";
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                @for (
                  proprietaire of filteredProprietaires;
                  track proprietaire.id
                ) {
                  <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="flex items-center">
                        <div
                          class="flex-shrink-0 h-10 w-10 bg-primary-light rounded-full flex items-center justify-center text-primary font-bold"
                        >
                        ...
                        <div class="ml-4">
                          ...
                          <div class="text-sm text-gray-500">
                            {{ proprietaire.email || "Pas d'email" }}
                          </div>
                        </div>
                      </div>
                    </td>
...
export class ProprietairesListComponent implements OnInit {
  ...
  applyFilters(): void {
    this.proprietairesService
      .filterProprietaires({ ...this.filters, recherche: this.recherche })
      .subscribe({
        next: (data) => {
  ...
  navigateToNew(): void {
    void this.router.navigate(["/proprietaires/new"]);
  }
  ...
  editProprietaire(id: string): void {
    void this.router.navigate(["/proprietaires", id, "edit"]);
  }
