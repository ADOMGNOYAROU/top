...
@Component({
  ...
  imports: [CommonModule, RouterModule, LokMontantFcfaComponent],
  animations: [
    trigger("fadeIn", [
      transition(":enter", [
        style({ opacity: 0 }),
        ...
        <div class="dashboard-content">
          ...
          <div class="section-card" @slideIn>
            <div class="section-header">
              ...
              <a routerLink="/gestionnaire/alertes" class="view-all-link"
                >Voir tout →</a
              >
            </div>
            ...
            <div *ngIf="alertes.length > 0" class="alerts-list">
              <div
                *ngFor="let alert of alertes; let i = index"
          ...
          <div class="section-card" @slideIn>
            ...
            <div class="actions-grid">
              <button
                class="action-card"
                routerLink="/gestionnaire/biens/nouveau"
              >
              ...
              <button
                class="action-card"
                routerLink="/gestionnaire/locataires/nouveau"
              >
              ...
              <button
                class="action-card"
                routerLink="/gestionnaire/paiements/nouveau"
              >
