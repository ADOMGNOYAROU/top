      ...
      <div class="p-6 max-w-4xl mx-auto">
              ...
              <div class="flex-1">
                ...
                <div class="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p class="font-semibold">
                      {{ logement.dateEntree | date: "dd/MM/yyyy" }}
                    </p>
                  </div>
                  <div>
                    <p class="text-gray-500">Fin de bail</p>
                    <p class="font-semibold">
                      {{ logement.finBail | date: "dd/MM/yyyy" }}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
          ...
          >
            ...
            <button routerLink="/paiements/nouveau" class="btn-primary text-sm">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
          ...
          <div class="p-4 border-t border-gray-200">
            <button (click)="showNewDemande = true" class="btn-primary w-full">
              Nouvelle demande
            </button>
          </div>
        </div>
              ...
              <div class="space-y-4">
                <div>
                  <label
                    ...
                    for="locataire-demande-type"
                    >Type de demande</label
                  >
                  <select id="locataire-demande-type" class="input-field">
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-gray-700 mb-2"
                    for="locataire-demande-description"
                    >Description</label
                  >
                  <textarea
                    id="locataire-demande-description"
                    class="input-field"
                    rows="4"
                ...
                <div class="flex gap-4">
                  <button (click)="envoyerDemande()" class="btn-primary flex-1">
                    Envoyer
                  </button>
                  <button
