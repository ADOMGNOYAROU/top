      ...
      <div class="p-6 max-w-4xl mx-auto">
          ...
          >
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label
                  ...
                  for="export-type-donnees"
                  >Type de données</label
                >
                <select
                  id="export-type-donnees"
            ...
            <div>
              <span class="block text-sm font-medium text-gray-700 mb-2"
                >Champs à inclure</span
              >
              <div
                class="grid grid-cols-2 md:grid-cols-4 gap-2"
                formGroupName="champs"
              >
                <label class="flex items-center">
                  <input
                    type="checkbox"
                    formControlName="informationsGenerales"
                    class="mr-2"
                  />
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
          ...
          @if (exportsRecents.length === 0) {
            <div class="p-6 text-center text-gray-500">Aucun export récent</div>
          } @else {
                ...
                >
                  <div class="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-gray-600">
                        {{ export.date | date: "dd/MM/yyyy HH:mm" }} •
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 mt-6">
          ...
          <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p class="text-sm text-gray-600">
                Export complet des données du mois
              </p>
            </button>
...
export class ExportComponent {
  ...
  exportForm: ReturnType<ExportComponent["buildForm"]>;
  isExporting: boolean = false;
  isDownloading: boolean = false;
  errorMessage: string = "";
  successMessage: string = "";

  exportsRecents: ExportRecent[] = [
    {
      id: "1",
  ...
  constructor() {
    this.exportForm = this.buildForm();
  }
  ...
  private buildForm() {
    return this.fb.nonNullable.group({
      ...
      dateDebut: [""],
      dateFin: [""],
      champs: this.fb.nonNullable.group({
  ...
  exporterDonnees(): void {
    ...
    setTimeout(() => {
      ...
      const typeDonnees = formValue.typeDonnees;
  ...
  telechargerExport(exportId: string): void {
    ...
    setTimeout(() => {
      ...
      const target = this.exportsRecents.find((e) => e.id === exportId);
      alert(`Export "${target?.titre ?? exportId}" téléchargé avec succès !`);
    }, 1500);
  }
