...
export class AdminService {
  ...
  changerStatutCompte(
    ...
    return this.http
      .patch<CompteUtilisateur>(`${this.apiUrl}/comptes/${id}`, { statut })
      .pipe(
        catchError((error: HttpErrorResponse) => {
  ...
  getTransactions(): Observable<TransactionSupervisee[]> {
    return this.http
      .get<TransactionSupervisee[]>(`${this.apiUrl}/transactions`)
      .pipe(
        catchError((error: HttpErrorResponse) => {
          console.error(
  ...
  resoudreLitige(id: string, resolution: string): Observable<Litige> {
    return this.http
      .patch<Litige>(`${this.apiUrl}/litiges/${id}`, {
  ...
  getStatistiques(): Observable<StatistiquesPlateforme> {
    return this.http
      .get<StatistiquesPlateforme>(`${this.apiUrl}/statistiques`)
      .pipe(
        catchError((error: HttpErrorResponse) => {
          console.error(
  ...
  private getMockLitiges(): Litige[] {
    return [
      ...
      },
      {
        ...
        priorite: PrioriteLitige.MOYENNE,
